...
public class MyCustomBeanProcessor implements BeanPostProcessor, BeanFactoryAware, DisposableBean {
	...
	public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
		...
		System.out.println("Doing the MyCustomBeanProcessor::postProcessAfterInitialization thing with + " + beanName);
	...
	public void destroy() throws Exception {
		...
		System.out.println("Doing the MyCustomBeanProcessor::destroy thing");
